...
//ћы видели, что вызваны были только деструкторы базового интерфейса, так как деструктор св€зываетс€ статически

//–ешением этой проблемы €вл€етс€ использование "виртуального деструктора"
//≈сли деструктор назначить виртуальным, то он тоже будет вызыватьс€ по указателю
//¬ажно в базовых классах организовывать виртуальный деструктор, так как иначе работа с подтипами в динамической пам€ти может существенно осложнитьс€ 
